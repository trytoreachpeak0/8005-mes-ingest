    ...
    private static IEnumerable<V2Operation> CreateOperations()
    {
        ...
        yield return Operation(
            ...
            [
                ...
                Query("window", "Rolling/all-history preset; mutually exclusive with from/to.", values: [ErrorSearchWindowKinds.Last24Hours, ErrorSearchWindowKinds.Last7Days, ErrorSearchWindowKinds.Last15Days, ErrorSearchWindowKinds.AllHistory], defaultValue: ErrorSearchWindowKinds.Last7Days),
...
internal sealed class NewMesIngestOpenApiSchemaFilter : ISchemaFilter
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyList<string>> StableValues =
        new Dictionary<string, IReadOnlyList<string>>(StringComparer.Ordinal)
        {
            ...
            ["ErrorSearchWindowDto.kind"] = ["LAST_24_HOURS", "LAST_7_DAYS", "LAST_15_DAYS", "ALL_HISTORY", "CUSTOM"],
